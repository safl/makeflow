#!/usr/bin/env python3
"""
    This script organizes the sphinx site / documentation
...
def parse_args():
    ...
    prsr = argparse.ArgumentParser(
        description="sphinx documentation organizer",
    ...
    prsr.add_argument(
        "--ref",
        help="Repository reference (e.g. refs/heads/docs or refs/tags/v1.2.3)",
    )
    prsr.add_argument(
        "--url", help="Base URL for versions.json e.g. https://{userid}.github.io/{reponame}", type=str
    )
